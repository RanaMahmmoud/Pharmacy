...
public struct AlertToast: View{
    ...
    public var banner: some View{
        VStack{
            ...
            .alertBackground(Color.gray.opacity(0.4)) //(style?.backgroundColor ?? .black)
            .cornerRadius(10)
    ...
    public var hud: some View{
        Group{
                    ...
                    VStack(alignment: type == .regular ? .center : .leading, spacing: 2){
                        ...
                        if subTitle != nil{
                            Text(LocalizedStringKey(subTitle ?? ""))
                                ...
                                .opacity(0.7)
                                .multilineTextAlignment(.center)
                                .textColor(style?.subtitleColor ?? .white)
                        }
                    }
                }
            }
            ...
            .padding(.vertical, 8)
            .frame(minHeight: 50)
            .alertBackground(Color.gray.opacity(0.4))//(style?.backgroundColor ?? nil)
            .clipShape(Capsule())
